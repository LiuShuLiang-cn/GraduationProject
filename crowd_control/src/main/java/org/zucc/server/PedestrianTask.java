...
public class PedestrianTask {
    ...
    private void updateNumber(int num, String systemName, List<NumberOfPeople> numberOfPeopleList) {
        ...
        Deploy deploy = (Deploy) redisTemplate.opsForValue().get(systemName + "_deploy");
        if (operate == null) {
        ...
        List<Weight> weights = updateWeightByDeploy(categoryList);
        /*根据权重新分配人数*/
    ...
    private List<Weight> updateWeightByDeploy(List<Weight> weights){
        return weights;
    }
